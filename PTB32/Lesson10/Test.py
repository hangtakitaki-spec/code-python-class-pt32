'''
Tự luận (2.0đ): Viết chương trình nhập vào một số nguyên dương n là số
bài kiểm tra mà em đã làm, nhập n số tiếp lần lượt là điểm số của em
cho các bài kiểm tra tương ứng. Hãy:
...
'''
Câu 9- L6(1.0đ): Xây dựng chương trình nhập vào một số nguyên dương n.
Hãy tính tổng các số từ 1 đến n bằng cách sử dụng vòng lặp for 
và in kết quả ra màn hình.
Yêu cầu: Sử dụng vòng lặp while và break
'''
while True:
    n = int(input("Nhập vào giá trị: "))
    if n < 0:
